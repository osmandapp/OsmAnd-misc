...
#borders ok
CENTRAL_AMERICA="anguilla antigua-and-barbuda aruba bahamas barbados cayman-islands costa-rica cuba el-salvador jamaica guadeloupe martinique montserrat panama puerto-rico saint-vincent-and-the-grenadines trinidad-and-tobago virgin-islands-british virgin-islands-us" 
convert "$EXTRACT_DIR"/central-america.pbf  "polygons/central-america" $CENTRAL_AMERICA

#need to fix borders...
CENTRAL_AMERICA2="dominica grenada honduras netherlands-antilles nicaragua" 
