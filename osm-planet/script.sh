...
convertFolder "$EXTRACT_DIR"/central-federal-district.pbf  "polygons/russia-regions/central-federal-district/" "russia"
convertFolder "$EXTRACT_DIR"/far-eastern-federal-district.pbf  "polygons/russia-regions/far-eastern-federal-district/" "russia"
convertFolder "$EXTRACT_DIR"/north-caucasus-federal-district.pbf  "polygons/russia-regions/north-caucasus-federal-district/" "russia"
convertFolder "$EXTRACT_DIR"/northwestern-federal-district.pbf  "polygons/russia-regions/northwestern-federal-district/" "russia"
convertFolder "$EXTRACT_DIR"/siberian-federal-district.pbf  "polygons/russia-regions/siberian-federal-district/" "russia"
convertFolder "$EXTRACT_DIR"/south-federal-district.pbf  "polygons/russia-regions/south-federal-district/" "russia"
convertFolder "$EXTRACT_DIR"/ural-federal-district.pbf  "polygons/russia-regions/ural-federal-district/" "russia"
convertFolder "$EXTRACT_DIR"/volga-federal-district.pbf  "polygons/russia-regions/volga-federal-district/" "russia"
